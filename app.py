...
lineaccesstoken = 'HCPujry9U8UdqBiEBlZZZhAi2cv1ufLhdLVRvmAGMB2z93LY+ifHzULTk5XPp4NWcGaXQicruMNp+K9GSaYp9DPNdG4062HpAqPFbRlZ8ZdLZM/ys7p4XfyeDsodFSAqLLtFufLe95ByFg/8dJB1tgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "หวัดดี":
            replyObj=TextSendMessage (text="เออ...ดีๆๆ")
        elif msg == "กินข้าวมั้ย":
            replyObj=TextSendMessage (text="กินดิ")
        elif msg == "ไปเที่ยวกันมั้ยยย":
            replyObj=TextSendMessage (text="ไม่อ่ะ ขก")
        else msg == "นอนเหอะ":
            replyObj=TextSendMessage (text="เออๆ")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers 
            json_headers = ({k:v for k, v in headers.items()}) 
            json_headers.update({'Host':'bots.dialogflow.com'}) 
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/8a9db705-ceb0-4521-ac4b-530009a682dd" 
